...
def main():
    ...
    if action == "1":
        ...
        file_path = input("🗑️ Nhập đường dẫn file muốn xoá trong repo (VD: file.txt): ").strip()
        delete_file(token, username, repo_name, file_path)
